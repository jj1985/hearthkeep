...
const BUILDINGS := [
    ...
    {"id":"upgrades",    "label":"Architect",         "scene":"res://scenes/ui/upgrade_panel.tscn",    "pos":Vector3( -4, 0,  12), "color":Color(0.95, 0.85, 0.55)},
    ...
    {"id":"engraving",   "label":"Engraving Bench",   "scene":"res://scenes/crafting/engraving_ui.tscn","pos":Vector3(  8, 0, -12), "color":Color(0.85, 0.75, 0.55)},
]
